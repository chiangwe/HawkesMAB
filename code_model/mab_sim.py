...
if __name__ == '__main__':
	...
	if (sim_phase == "val_phase"):
		...
		if method == 'ucb1_mab':
			...
			list_sim = list( range(0, n_sim) )
			list_gamma = [0.001, 0.01, 0.1, 0.3, 0.5];
			list_eta = [0.05, 0.1, 0.3, 0.5, 0.8, 1, 5, 10]
			...
			list_alpha = [ 0.000001, 0.000005, 0.00001  ];
			list_eta   = [ 0.000001, 0.000005, 0.00001 ];
			...
			list_eta = [0.001, 0.005, 0.01, 0.05, 0.1];
